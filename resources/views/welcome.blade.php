    ...
    class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    <div class="ml-4 text-center text-sm text-black-50 sm:text-right sm:ml-0">
                        THIS BACKEND IS FOR ONLY API. INSTALL admin_frontend FOLDER TO FINISH BACKEND INSTALLATION
                    </div>
                </div>
            </div>
</div>
...
<script>
    const conn = new WebSocket('wss://demo-api.foodyman.org:8080');

    conn.onopen = function (e) {
        console.log(`Connection established! ${e?.message}`);
        console.log(e);
